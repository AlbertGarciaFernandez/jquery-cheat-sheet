...
function vanillaJavaScript(id) {
  ...
  switch (number) {
    ...
    case 14:
      ...
      break;
    case 15:
      codeTextVjs.innerText = `What did you hope there was here when you clicked it? This is the Vanilla display. Look right`;
      break;
    case 16:
      codeTextVjs.innerText = `What did you hope there was here when you clicked it? This is the Vanilla display. Look right`;
      break;
...
function vanillaJavaScriptevents(id) {
  let number = id;
  let btn = document.createElement("button");
  let demoText = document.createElement("p");
  btn.classList.add("demo-btn");
...
function vanillaJavaScripselectors(id) {
  let number = id;
  let btn = document.createElement("button");
  let demoText = document.createElement("p");
  btn.classList.add("demo-btn");
